...
function Translate() {
  ...
  return (
    <div className="translate w-full">
          ...
          <div className="sign-input-area">
            ...
            <div className="button-container">
              <button onClick={() => {
                ...
                loadAtoZScript();
              }} className='bg-blue-200 hover:bg-blue-700'>A to Z</button>
              <button onClick={() => {
                setShowAtoZModal(false);
                setShowNumberModal(true);
                loadNumberScript();
              }} className='bg-blue-200 hover:bg-blue-700'>Numbers 1-10</button>
            </div>
          </div>
        </div>
      ...
      {showAtoZModal && (
        <div className="modal">
          <div className="modal-content justify-center">
            <div><h2 className='text-center'>A to Z Sign Language Recognition</h2></div>
            {/* <div>Model</div> */}
      ...
      {showNumberModal && (
        <div className="modal w-full mt-8">
          <div className="modal-content">
            <div><h2 className='text-center'>Numbers 1-10 Sign Language Recognition</h2></div>
            {/* <div>Model</div> */}
            <div className='text-center'>
